...
namespace SkyfishIntegration\Helper;
...
class CacheBust
{
    ...
    public static function getRevManifest()
    {
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . SKYFISHINTEGRATION_PATH . ' and run gulp. See '. SKYFISHINTEGRATION_PATH . 'README.md for more info.</div>';
        }
    }
}

	...
	render() {
		...
		const DirectionController = props => {
			...
			return (
				<button
					className={
						"u-bg-initial link u-border-0 u-font-inherit pricon pricon-sort-" +
		...
		const OrderController = props => {
			...
			return (
				<Dropdown
					...
					list={orderOptions}
					toggleClass="link u-border-0 u-font-inherit pricon pricon-sort u-bg-initial"
				/>
			);
		};
		...
		return (
			<div>
				...
				<div className="grid sm-gutter  grid--columns">{items}</div>
